...
#MODEL DESCRIPTION
#XGBOOST MODEL SEED = 123 and NROUND = 526
#LOAD DATA
train <- read.csv("../data/train_processed.csv", header = TRUE, stringsAsFactors = FALSE)
test <- read.csv("../data/test_processed.csv", header = TRUE, stringsAsFactors = FALSE)
...
write_csv(submission,"../Submissions/XGB_MODEL_S123_N526.csv")  
