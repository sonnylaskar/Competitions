...
H1 <- read_csv("../input/First_Health_Camp_Attended.csv")
H1$"NA" <- NULL 

H2 <- read_csv("../input/Second_Health_Camp_Attended.csv")
H3 <- read_csv("../input/Third_Health_Camp_Attended.csv")

Camp_details <- read_csv("../input/Health_Camp_Detail.csv")
patient <- read_csv("../input/Patient_Profile.csv")
