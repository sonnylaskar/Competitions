...
def main():
        ...
        model=LogisticRegression(penalty='l2',tol=0.001, C=1.0, random_state=1, solver='liblinear', max_iter=100)

        metafolder="meta_folder/" # folder to use to store for meta predictions
        outset="marios_logit_v2" # predic of all files
