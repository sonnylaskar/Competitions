...
def main():
        ...
        outset="marios_xgsonv2_v5" # predic of all files

        #model to use

        model=xg.XGBoostClassifier(num_round=1000 ,nthread=threads,  eta=0.1, gamma=0.0,max_depth=20, min_child_weight=1, subsample=1.0,
                                   colsample_bytree=0.9,objective='binary:logistic',silent=True, seed=1)
